...
def main():
    print(f"Injecting Step 2 Advanced Engines into: {ROOT.resolve()}")
    for rel_path, content in FILES.items():
        abs_path = ROOT / rel_path
        write_file(abs_path, content)
        print(f"✔ Upgraded {rel_path} with Jump-Diffusion Matrix")
    print("\nPhase 2 Complete. Ready to push to GitHub.")
